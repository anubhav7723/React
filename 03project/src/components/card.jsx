...
function Card({title,nameText}) {
    
    return (
        <>
            <div className="rounded-xl bg-white mt-4" class="bg-white py-24 sm:py-32 ">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:text-center">
                        <h2 class="text-base/7 font-semibold text-indigo-600">{title}</h2>
                        <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance">{nameText|| "gupta"}</p>
